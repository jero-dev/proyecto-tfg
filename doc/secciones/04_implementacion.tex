...
y procesar los mensajes de los canales de ofertas en donde esté. Se puede encontrar 
el código fuente de este en el directorio \verb|src/bot/telegram/collector|. Este 
bot utilizará la librería 
\href{https://github.com/go-telegram-bot-api/telegram-bot-api}{Telegram Bot API} 
para las conexiones con la API de Telegram. Con esto, el desarrollo del bot es 
mucho más ligero que si lo tuviéramos que hacer por nuestra cuenta.
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{figuras/metodos-actualizacion.png}
